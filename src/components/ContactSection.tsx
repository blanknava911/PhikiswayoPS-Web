    ...
    <section className="py-20 bg-[#F9F9F9]" id="contact-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-8 sm:p-10 mb-16 shadow-md flex flex-col md:flex-row items-center justify-between gap-6" id="social-follow-banner">
          ...
          {/* Social Media Buttons: Facebook, WhatsApp, YouTube */}
          <div className="flex flex-wrap items-center gap-3" id="social-buttons-group">
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/27815091460"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20ba59] text-white px-5 py-3 rounded-xl font-bold text-sm shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5 active:scale-95 cursor-pointer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-[#CC0000] hover:bg-[#b30000] text-white px-5 py-3 rounded-xl font-bold text-sm shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5 active:scale-95 cursor-pointer"
